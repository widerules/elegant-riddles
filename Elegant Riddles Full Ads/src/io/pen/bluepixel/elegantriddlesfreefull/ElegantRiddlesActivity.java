...
public class ElegantRiddlesActivity extends Activity implements OnGestureListener, ViewFactory {
    ...
    private static final int[] LOOKUP_TITLES=new int[]{R.string.play, R.string.random, R.string.credits, R.string.ftw };
    private static final int[] LOOKUP_SUBTITLES=new int[]{R.string.tableOfContents, R.string.random_sub,
	R.string.credits_sub, R.string.ftw_sub };
	...
	switch (menuPosition) {
	    ...
	    case 4:
		// FTW
		Intent iii=new Intent(Intent.ACTION_VIEW, Uri.parse(MARKET_URL_FTW));
		startActivity(iii);
		break;
	}
    }
